    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (selectedVehicle === truck) {
            ...
            if (typeof truck.tow === 'function') {
                truck.tow(selectedVehicle);
                console.log(
                    `The truck is now towing: ${selectedVehicle.make} ${selectedVehicle.model}`);
            } else {
                console.log("This truck cannot tow vehicles.");
            }
        }
      }); 
  }
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            ...
            //   return;  // avoid immediately calling performActions() again
            // }
            if (this.vehicles[i].vin === this.selectedVehicleVin && this.vehicles[i] instanceof Truck) {
